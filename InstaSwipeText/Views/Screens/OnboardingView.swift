...
struct OnboardingView: View {
    ...
    let tabs: [(String, String, String, Int)] = [
        ("animation1",
         "L_Onboard_Title_1".localized(),
         "L_Onboard_SubTitle_1".localized(), 0),
        ("animation2",
         "L_Onboard_Title_2".localized(),
         "L_Onboard_SubTitle_2".localized(), 1),
        ("animation3",
         "L_Onboard_Title_3".localized(),
         "L_Onboard_SubTitle_3".localized(), 2)
    ]
...
struct OnboardingTabsView<Content: View>: View {
    ...
    @State private var buttonText = "L_NEXT".localized()
    ...
    private func change(newValue: (any Equatable)) {
        if (newValue as! Int) < 2 {
            buttonText = "L_NEXT".localized()
        }
        if (newValue as! Int) == 2 {
            buttonText = "L_FINISH".localized()
        }
    }
